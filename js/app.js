...
(function ($) {
    ...
    $(function () {
        ...
        setHeaderMenuPhone();
        setHeaderSearch();
        setWaves();// TODO 显示水波纹效果
        // setScrollReveal(); // TODO  页面滚动显示文章
        setTocToggle();
        getHitokoto();
        getPicture();
        ...
        $('body').delegate('img:not(.avatar)', 'click', function () {
            window.open(this.src);
        });

        // 激活目录
        $('.h-list li a').each(function () {
            // 首页
            if (location.href === this.href){
                $('.h-list li.active').removeClass('active');
